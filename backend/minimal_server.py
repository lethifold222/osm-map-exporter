...
try:
    from real_osm_extractor import RealOSMExtractor
except ImportError:
    print("⚠️ RealOSMExtractor not available, using mock data")
...
class OSMRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if parsed_path.path == '/api/health':
            ...
            response = {"message": "File not found - export not yet implemented"}
            self.wfile.write(json.dumps(response).encode())
